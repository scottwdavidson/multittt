...
public class MinMaxBoardEvaluator extends BoardEvaluator {
    ...
    /**
     * The whole TTT board is worth 99 points ( e.g., 9 wins ). As draws are introduced, wins (and conversely losses)
     * become more valuable ( more negative valued ) as we keep the overall board value at 99.
     * <p>
     * For example:
     * 0 draws : a win is worth 10 points ( a loss is -10 points )
     * 2 draws : a win is worth 99/7 points (~14 points) ( a loss is ~-14 points )
     * 5 draws : a win is worth 99/4 points (~24 points)
     * </p>
     * <p>
